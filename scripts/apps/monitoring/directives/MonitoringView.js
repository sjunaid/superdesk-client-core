 ...
 */
MonitoringView.$inject = ['$rootScope', 'authoringWorkspace', 'pageTitle', '$timeout', 'desks'];
export function MonitoringView($rootScope, authoringWorkspace, pageTitle, $timeout, desks) {
    return {
