describe('monitoring', function() {
    ...
    xit('can switch between list and swimlane view', inject(function($controller, $rootScope, storage, config) {
        config.features = {
        ...
        expect(ctrl.getSwimlaneView).toBe(1);

        // Default will be list view
        storage.clear();
        expect(ctrl.viewColumn).toBe(null);       // no swimlane
        // display all groups for list view, i.e. limitTo: Infinity when no swimlane
